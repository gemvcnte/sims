import { allApplicationsEndpoint } from "@/config/adminEndpoints";
...
export const useAllApplications = () => {
  ...
  if (!context) {
    throw new Error(
      "useAllApplications must be used within a AllApplicationsProvider",
    );
  }
  return context;
};

export const AllApplicationsProvider = ({ children }) => {
  ...
  const fetchData = async () => {
    ...
    try {
      const response = await axiosInstance.get(allApplicationsEndpoint);
