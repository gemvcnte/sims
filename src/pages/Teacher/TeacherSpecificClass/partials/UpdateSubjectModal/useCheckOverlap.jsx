...
export const useCheckOverlap = (selectedTeacher) => {
  ...
  const checkOverlap = (schedules) => {
    const newSchedulesSubjectId = schedules[0].subjectId;

    const schedulesFromDbWithoutNewSchedules = schedulesFromDb.filter(
      (schedule) => schedule.subjectId !== newSchedulesSubjectId,
    );

    const selectedTeacherScheduleWithoutNewSchedules =
      selectedTeacherSchedule.filter(
        (schedule) => schedule.subjectId !== newSchedulesSubjectId,
      );
    ...
    const checkOverlapWithSchedulesFromDb = (newSchedules) => {
      const newSchedulesWithSchedulesFromDb = [
        ...newSchedules,
        ...schedulesFromDbWithoutNewSchedules,
      ];
    ...
    const checkOverlapWithSelectedTeacherSchedule = (newSchedules) => {
      const newSchedulesWithTeacherSchedules = [
        ...newSchedules,
        ...selectedTeacherScheduleWithoutNewSchedules,
      ];
