    ...
    <section className="parent-information-section p-4 sm:flex">
      <header className="mb-2 text-center md:max-w-[30%] md:text-start ">
        ...
        <p className="hidden text-sm font-thin text-muted-foreground sm:block">
          ...
          teacher's parent/guardian information.
        </p>
      </header>
      ...
      <main className="flex w-full flex-col gap-4">
        ...
        <div className="grid grid-cols-4 items-center gap-4">
          ...
          <InputField
            ...
            type="text"
            placeholder="Firstname Middlename Lastname"
            value={teacherProfile?.motherName}
        ...
        <div className="grid grid-cols-4 items-center gap-4">
          ...
          <InputField
            ...
            value={teacherProfile?.fatherContactNumber}
            onChange={(e) =>
        ...
        <div className="grid grid-cols-4 items-center gap-4">
          ...
          <InputField
            ...
            type="number"
            placeholder="+639xxxxxxxxx"
            value={teacherProfile?.motherContactNumber}
            onChange={(e) =>
        ...
        <div className="grid grid-cols-4 items-center gap-4">
          ...
          <InputField
            ...
            type="number"
            placeholder="+639xxxxxxxxx"
            value={teacherProfile?.guardianContactNumber}
            onChange={(e) =>
        ...
        <div className="grid grid-cols-4 items-center gap-4">
          ...
          <select
            ...
            value={teacherProfile?.guardianRelationship}
            onChange={(e) =>
